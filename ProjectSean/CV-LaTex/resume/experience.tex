...
%---------------------------------------------------------
  \cventry
    {Self Taught - IBM/Google/MIT/Etc} % Job title
    {Full Stack Developer} % Organization
    {Canada} % Location
    {2021 - Present} % Date(s)
    {
...
%---------------------------------------------------------
  \cventry
    ...
    {
     % \begin{cvitems} % Description(s) of tasks/responsibilities
      %  \item {Was not allowed to attend university/'higher education' because I refused to take an untested so called medication because the TV/Govt/Big Phama told me to, If you are so smart - why are you taking god knows what mystery science juice?}
