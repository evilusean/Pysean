...
def download_channel_videos(channel_url, output_folder, subfolder_name):
    """Downloads videos from a YouTube channel and saves metadata and cover art.
    ...
    with yt_dlp.YoutubeDL(ydl_opts) as ydl:
        try:
            # Extract information about the channel
            info_dict = ydl.extract_info(channel_url, download=False)

            # Filter for videos (you might need to adjust this based on the structure of info_dict)
            videos = info_dict.get('entries', [])  # Assuming 'entries' is the key for videos
            ...
            print(f"Error downloading channel videos: {e}")
...
# Example usage:
channel_url = "https://www.youtube.com/@irvingforce/videos"  # Replace with your channel URL
output_folder = "/mnt/sdb2/Media/Music/1Youtube/"  # Replace with your desired output folder
subfolder_name = "IrvingForce"  # Replace with your desired subfolder name

download_channel_videos(channel_url, output_folder, subfolder_name)
