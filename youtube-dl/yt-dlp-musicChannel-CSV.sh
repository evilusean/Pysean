...
#Input CSV Example: (channel URL, subfolder name)
#https://www.youtube.com/@anotherchannel/videos,AnotherChannel
#https://www.youtube.com/@idleglance/videos,IdleGlance

# Input CSV file
csv_file="/mnt/sdb2/Media/Music/1Youtube/Update.csv"
...
while IFS=, read -r channel_url subfolder_name; do
  echo "Processing channel: $channel_url, subfolder: $subfolder_name"
  ...
  # Clear the arrays for the next channel
  temp_files=()
  image_files=()
done < "$csv_file"