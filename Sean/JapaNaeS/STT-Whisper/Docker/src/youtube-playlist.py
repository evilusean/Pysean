...
class YouTubePlaylistTranslator:
    def __init__(self, url, source_lang="ja"):
        self.url = url
        self.source_lang = source_lang
        
        print("\nInitializing YouTube Playlist Translator...")
...
if __name__ == "__main__":
    ...
    if youtube_url:
        translator = YouTubePlaylistTranslator(youtube_url, source_lang)
        translator.download_audio()
